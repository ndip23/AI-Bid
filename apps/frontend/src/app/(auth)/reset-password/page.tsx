      ...
      <main className="flex-1 flex flex-col justify-center items-center px-4 pt-28 pb-16">
        <div className="w-full max-w-md space-y-6 glass-panel rounded-3xl p-8 bg-white border border-slate-200 shadow-xl relative z-10">
          <div className="text-center space-y-2">
            <div className="w-12 h-12 rounded-2xl gradient-bg flex items-center justify-center mx-auto shadow-md shadow-blue-600/20">
          ...
          {submitted ? (
            <div className="p-5 rounded-2xl bg-emerald-50 border border-emerald-200 text-emerald-900 text-xs font-semibold text-center space-y-3">
              ...
              <Link href="/login" className="text-blue-600 font-extrabold block hover:underline pt-1">
                Back to Sign In
              </Link>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full py-3 rounded-xl gradient-bg text-white font-extrabold text-xs shadow-md shadow-blue-600/20 hover:opacity-95 transition-opacity flex items-center justify-center space-x-2"
              >
